...
|---|------|-------|----------|--------|-----------|------------|
| D001 | M001/S01 | process | Feature branch strategy | `feat/room-first-ux` from upstream 2f097aa | Clean slate — no M001-M004 code carried. Cherry-pick infrastructure only. | No |
...
| D005 | M001/S01 | arch | Test infrastructure source | Port from prior milestones, strip M001-M004 additions | MockReadTransport, MockWriteClient, testApp are battle-tested. Stripped mqttClient (not in upstream ServerDependencies). | No |
